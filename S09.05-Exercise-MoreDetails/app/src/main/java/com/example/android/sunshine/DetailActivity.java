...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    private TextView tv_date, tv_description, tv_high_temperature, tv_low_temperature, tv_humidity, tv_wind, tv_pressure;
...
//      COMPLETED (13) Find each of the TextViews by ID
        ...
        tv_description = (TextView)findViewById(R.id.tv_weather_description);
        tv_high_temperature = (TextView)findViewById(R.id.tv_high_temperature);
        tv_low_temperature = (TextView)findViewById(R.id.tv_low_temperature);
...
//      COMPLETED (33) Store a forecast summary in mForecastSummary
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        long locarDateMidnightGMT = data.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this,locarDateMidnightGMT,true);
        tv_date.setText(dateText);

        int weather_id = data.getInt(INDEX_WEATHER_CONDITION_ID);
        String weather_desc = SunshineWeatherUtils.getStringForWeatherCondition(this,weather_id);
        tv_description.setText(weather_desc);

        double highInCelsius = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString = SunshineWeatherUtils.formatTemperature(this,highInCelsius);
        tv_high_temperature.setText(highString);

        double lowInCelsius = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString = SunshineWeatherUtils.formatTemperature(this,lowInCelsius);
        tv_low_temperature.setText(lowString);
        ...
        mForecastSummary = String.format("%s - %s - %s/%s",
                dateText, weather_desc, highString, lowString);
