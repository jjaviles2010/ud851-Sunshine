...
//              COMPLETED (13) Check if notifications are enabled
                boolean notifiationsEnabled = SunshinePreferences.areNotificationsEnabled(context);

                if(notifiationsEnabled) {
//              COMPLETED (14) Check if a day has passed since the last notification
                ...
                if(oneDayPassedSinceLastNotification && notifiationsEnabled){
